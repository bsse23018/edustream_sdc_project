              ...
              child: SingleChildScrollView(
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text("EduStream CI/CD test", style: Theme.of(context).textTheme.headlineMedium!.copyWith(fontWeight: FontWeight.bold, color: const Color(0xFF6366F1))),
                      const SizedBox(height: 5),
                      Text(isLogin ? "Welcome Back feelows" : "Start Learning", style: TextStyle(color: Colors.grey[500])),
